...
<body>
    ...
    <div class="card d-flex justify-content-center align-items-center mx-auto mt-5 bg-light" style="width: 70%">
        <div class="card-body">
            <h3 class="fw-bold text-center">新增時段</h3>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- 樓層頁籤 -->
                                            <ul class="d-flex nav nav-tabs mb-5 bg-success rounded nav-fill" id="floorTab" role="tablist">
